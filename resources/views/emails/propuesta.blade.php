                                  ...
                                  <tbody>
                                    <tr>
                                      <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0">
                                          ...
                                          <tr>
                                            <td align="center"><font style="font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left"><a href="#" target="_blank" style="color:#474b53; text-decoration:none"></a> <a href="#" target="_blank" style="color:#474b53; text-decoration:none"></a></font></td>
                                          </tr>
                                          <tr>
                                            <td align="center">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td height="6" bgcolor="#1f3ca6" class="contents" style="width:100%; border-top-left-radius:10px; border-top-right-radius:10px"></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                  </tbody>
                          ...
                          <![endif]-->
                                              ...
                                              <div class="column" style="width:100%;max-width:415px;display:inline-block;vertical-align:top;">
                                                <table width="100%" style="border-spacing:0" bgcolor="#ffffff">
                                                  ...
                                                  <tr>
                                                    <td class="inner" style="padding-top:10px;padding-bottom:0px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%" bgcolor="#FFFFFF">
  <!--                                                      <tr>
                                                          <td align="right" valign="bottom" class="text"><font style="font-size:14px; text-decoration:none; color:#5b5f65;font-family:Arial, Helvetica, sans-serif"><strong><a href="#" style="color:#5b5f65; text-decoration:none">ABOUT</a> | <a href="#" style="color:#5b5f65; text-decoration:none">PRESS</a> | <a href="#" style="color:#5b5f65; text-decoration:none">CONTACT</a></strong></font></td>
                                                        </tr> -->
                                                      </table></td>
                                                  </tr>
                                                </table>
                          ...
                          <![endif]--></td>
                                          ...
                                          <tr>
                                            <td align="left" style="padding-left:40px"><table border="0" cellpadding="0" cellspacing="0" style="border-bottom:2px solid #1F3CA6" align="left">
                                                <tr>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="center" style="padding:0px 40px 0px 40px"><p style="color:#5b5f65; font-size:25px; text-align:center; font-family: Verdana, Geneva, sans-serif"><p style="color:#0074B8; font-size:30px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong> SISTEMA DE COMPRAS INCOTEC </strong> </p><p style="color:#5b5f65; font-size:24px; text-align:center; font-family: Verdana, Geneva, sans-serif"><strong> Propuesta recibida desde el Sistema de Compras </strong> </p>

                      <p style="color:#5b5f65; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif">Se ha recibido un mensaje de propuesta desde el portal de Sistemas de Compras.
                      </p>
...
-->
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" border="0"  bgcolor="#1f3ca6">
      <tr>
        <td height="40" align="center" bgcolor="#1f3ca6" class="one-column">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" bgcolor="#1f3ca6" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:#ffffff; font-family: Verdana, Geneva, sans-serif; text-align:center">5º Anillo, Esquina Radia 27, Santa Cruz de la Sierra, Bolivia.</font></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#1f3ca6" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="center" bgcolor="#1f3ca6" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:#ffffff; font-family: Verdana, Geneva, sans-serif; text-align:center">© Copyright 2017. All Rights Reserved - <a href="http://www.grayhatcorp.com" target="_blank" style="color:#ffffff; text-decoration:none; font-style: italic;">Desarrolladores</a></font></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#1f3ca6" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">&nbsp;</td>
      </tr>
      <tr>
        <td height="6" bgcolor="#1f3ca6" class="contents1" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
      </tr>
      </table></td>
  </tr>
  <tr>
